...
\newcommand{\nametext}{\textit{Active culture yogurt}}
\newcommand{\desc}{If you have the ability to digest lactose, gain 2 health immediately.  In addition draw from the deck and place the first non-pathogen in your beneficial area.}
