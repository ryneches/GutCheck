...
\newcommand{\nametext}{\textit{Bug Op 2}}
\newcommand{\desc}{When this species is in play as a beneficial microbe it synthesizes vitamin B2 (riboflavin); gain one additional health at end of turn }
